...
- **Thành viên 1**: Nguyễn Xuân Quang - MSSV: 1871020483
- **Thành viên 2**: Nguyễn Anh Tuấn - MSSV: 1871020484

## Task division

- **Nguyễn Xuân Quang phụ trách chính**:
  - sender.py
  - DES encryption
  - packet structure

- **Nguyễn Anh Tuấn phụ trách chính**:
  - receiver.py
  - testing
  - logging
...
- **Nguyễn Xuân Quang demo**:
  - Sender
  - packet flow
  - encryption process

- **Nguyễn Anh Tuấn demo**:
  - Receiver
  - decryption process
  - logs and testing
